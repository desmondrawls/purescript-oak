...
(function(exports) {
  ...
  var view = function (model) {
      return Oak_Html.div([  ])([ Oak_Html.div([  ])([ Oak_Html.text(Oak_Html_Present.presentString)("The laws of physics are only patterns, beginning with quantities.") ]), Oak_Html.div([  ])([ Oak_Html.text(Oak_Html_Present.presentString)("The quantity: " + Data_Show.show(Data_Show.showNumber)(model.randomness)) ]), Oak_Html.svg([ Oak_Html_Attribute.height(Oak_Html_Present.presentInt)(600), Oak_Html_Attribute.width(Oak_Html_Present.presentInt)(1200), Oak_Html_Events.onClick(GetRandom.value) ])(manyCircles) ]);
  };
