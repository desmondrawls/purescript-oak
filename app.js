...
(function(exports) {
  ...
  var SelectProject = (function () {
      function SelectProject(value0) {
          this.value0 = value0;
      };
      SelectProject.create = function (value0) {
          return new SelectProject(value0);
      };
  ...
  var update = function (v) {
      return function (model) {
          if (v instanceof Inc) {
              var $13 = {};
              for (var $14 in model) {
                  if ({}.hasOwnProperty.call(model, $14)) {
                      $13[$14] = model[$14];
                  };
              };
              $13.number = model.number + 1 | 0;
              return $13;
          };
          if (v instanceof Dec) {
              var $16 = {};
          ...
          if (v instanceof SelectProject) {
              ...
              $19.selectedProject = new Data_Maybe.Just(v.value0);
              return $19;
          };
          throw new Error("Failed pattern match at Main line 79, column 1 - line 79, column 32: " + [ v.constructor.name, model.constructor.name ]);
      };
  };
  var projectView = function (project) {
      return Oak_Html.div([  ])([ Oak_Html.div([ Oak_Html_Events.onClick(new SelectProject(project.id)) ])([ Oak_Html.text(Oak_Html_Present.presentString)(project.name) ]), Oak_Html.div([  ])([ Oak_Html.text(Oak_Html_Present.presentString)("Client: " + project.client) ]) ]);
  };
  var projectNameView = function (v) {
      if (v instanceof Data_Maybe.Nothing) {
          return "Unknown project";
      };
      if (v instanceof Data_Maybe.Just) {
          return v.value0.name + (" with " + v.value0.client);
      };
      throw new Error("Failed pattern match at Main line 50, column 1 - line 50, column 43: " + [ v.constructor.name ]);
  };
  var selectedProjectView = function (v) {
      return function (v1) {
          if (v1 instanceof Data_Maybe.Nothing) {
              return Oak_Html.div([  ])([ Oak_Html.text(Oak_Html_Present.presentString)("Please select a project.") ]);
          };
          if (v.length === 0) {
              return Oak_Html.div([  ])([ Oak_Html.text(Oak_Html_Present.presentString)("You have no projects to allocate to! Call some clients.") ]);
          };
          if (v1 instanceof Data_Maybe.Just) {
              var project = Data_Foldable.find(Data_Foldable.foldableArray)(function (project1) {
                  return project1.id === v1.value0;
              })(v);
              return Oak_Html.div([  ])([ Oak_Html.text(Oak_Html_Present.presentString)("Who wants to work on " + projectNameView(project)) ]);
          };
          throw new Error("Failed pattern match at Main line 54, column 1 - line 54, column 62: " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  var pivotView = function (pivot) {
      return Oak_Html.div([  ])([ Oak_Html.text(Oak_Html_Present.presentString)(pivot.firstName + (" " + pivot.lastName)) ]);
  };
  var view = function (model) {
      return Oak_Html.div([  ])([ Oak_Html.div([  ])([ Oak_Html.text(Oak_Html_Present.presentString)("Projects"), Oak_Html.div([  ])(Data_Functor.map(Data_Functor.functorArray)(projectView)(model.projects)) ]), Oak_Html.div([  ])([ Oak_Html.text(Oak_Html_Present.presentString)("Pivots"), Oak_Html.div([  ])(Data_Functor.map(Data_Functor.functorArray)(pivotView)(model.pivots)) ]), selectedProjectView(model.projects)(model.selectedProject) ]);
  };
  var next = function (v) {
      return function (v1) {
          return Oak_Cmd.none;
