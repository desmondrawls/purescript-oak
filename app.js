...
(function(exports) {
  ...
  var decodeCenters = new Data_Foreign_Class.Decode(Data_Foreign_Generic.genericDecode(genericCenters)(Data_Foreign_Generic_Class.genericDecodeConstructor(new Data_Symbol.IsSymbol(function () {
      ...
      $59.unwrapSingleConstructors = false;
      return $59;
  })()));
...
(function(exports) {
  ...
  var shapeView = function (randomness) {
      return function (size) {
          ...
          throw new Error("Failed pattern match at Main line 109, column 1 - line 109, column 46: " + [ randomness.constructor.name, size.constructor.name ]);
      };
  };
