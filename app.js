...
(function(exports) {
  ...
  var update = function (v) {
      return function (model) {
          if (v instanceof Inc) {
              var $11 = {};
              for (var $12 in model) {
                  if ({}.hasOwnProperty.call(model, $12)) {
                      $11[$12] = model[$12];
                  };
              };
              $11.number = model.number + 1 | 0;
              return $11;
          };
          if (v instanceof Dec) {
              var $14 = {};
              ...
              $14.number = model.number - 1 | 0;
              return $14;
          };
          throw new Error("Failed pattern match at Main line 53, column 1 - line 53, column 32: " + [ v.constructor.name, model.constructor.name ]);
      };
  };
  var next = function (v) {
      return function (v1) {
  ...
  var centers = [ new Data_Tuple.Tuple(200, 100), new Data_Tuple.Tuple(400, 30), new Data_Tuple.Tuple(150, 500) ];
  var manyCircles = Data_Functor.map(Data_Functor.functorArray)(circleView)(centers);
  var view = function (model) {
      return Oak_Html.div([  ])([ Oak_Html.div([  ])([ Oak_Html.text(Oak_Html_Present.presentString)("The laws of physics are only patterns, beginning with quantities.") ]), Oak_Html.svg([ Oak_Html_Attribute.height(Oak_Html_Present.presentInt)(600), Oak_Html_Attribute.width(Oak_Html_Present.presentInt)(1200) ])(manyCircles) ]);
  };
