...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];
  var Centers = function (x) {
      return x;
  };
  var genericTransportModel = new Data_Generic_Rep.Generic(function (x) {
      return new Data_Generic_Rep.Product(x.centers, new Data_Generic_Rep.Product(x.limit, new Data_Generic_Rep.Product(x.padding, new Data_Generic_Rep.Product(x.randomness, x.size))));
  }, function (x) {
      return {
          centers: x.value0,
  ...
  var genericCenter = new Data_Generic_Rep.Generic(function (x) {
      return new Data_Generic_Rep.Product(x.center_x, x.center_y);
  }, function (x) {
      return {
          center_x: x.value0,
          center_y: x.value1
  ...
  var encodeCenter = new Data_Foreign_Class.Encode(Data_Foreign_Generic.genericEncode(genericCenter)(Data_Foreign_Generic_Class.genericEncodeConstructor(new Data_Symbol.IsSymbol(function () {
      return "Center";
      ...
      return "center_y";
  }))(Data_Foreign_Class.intEncode)))))((function () {
      var $47 = {};
      for (var $48 in Data_Foreign_Generic.defaultOptions) {
          if ({}.hasOwnProperty.call(Data_Foreign_Generic.defaultOptions, $48)) {
              $47[$48] = Data_Foreign_Generic["defaultOptions"][$48];
          };
      };
      $47.unwrapSingleConstructors = true;
      return $47;
  })()));
  var encodeCenters = new Data_Foreign_Class.Encode(Data_Foreign_Generic.genericEncode(genericCenters)(Data_Foreign_Generic_Class.genericEncodeConstructor(new Data_Symbol.IsSymbol(function () {
      return "Centers";
  }))(Data_Foreign_Generic_Class.genericEncodeArgsArgument(Data_Foreign_Class.arrayEncode(encodeCenter))))((function () {
      var $50 = {};
      for (var $51 in Data_Foreign_Generic.defaultOptions) {
          if ({}.hasOwnProperty.call(Data_Foreign_Generic.defaultOptions, $51)) {
              $50[$51] = Data_Foreign_Generic["defaultOptions"][$51];
          };
      };
      $50.unwrapSingleConstructors = true;
      return $50;
  })()));
  var decodeCenter = new Data_Foreign_Class.Decode(Data_Foreign_Generic.genericDecode(genericCenter)(Data_Foreign_Generic_Class.genericDecodeConstructor(new Data_Symbol.IsSymbol(function () {
      return "Center";
      ...
      return "center_y";
  }))(Data_Foreign_Class.intDecode))))(Data_Foreign_Generic_Class.genericCountArgsRec))((function () {
      var $56 = {};
      for (var $57 in Data_Foreign_Generic.defaultOptions) {
          if ({}.hasOwnProperty.call(Data_Foreign_Generic.defaultOptions, $57)) {
              $56[$57] = Data_Foreign_Generic["defaultOptions"][$57];
          };
      };
      $56.unwrapSingleConstructors = true;
      return $56;
  })()));
  var decodeCenters = new Data_Foreign_Class.Decode(Data_Foreign_Generic.genericDecode(genericCenters)(Data_Foreign_Generic_Class.genericDecodeConstructor(new Data_Symbol.IsSymbol(function () {
      return "Centers";
  }))(Data_Foreign_Generic_Class.genericDecodeArgsArgument(Data_Foreign_Class.arrayDecode(decodeCenter)))(Data_Foreign_Generic_Class.genericCountArgsArgument))((function () {
      var $59 = {};
      for (var $60 in Data_Foreign_Generic.defaultOptions) {
          if ({}.hasOwnProperty.call(Data_Foreign_Generic.defaultOptions, $60)) {
              $59[$60] = Data_Foreign_Generic["defaultOptions"][$60];
          };
      };
      $59.unwrapSingleConstructors = true;
      return $59;
  })()));
  exports["Centers"] = Centers;
  exports["genericTransportModel"] = genericTransportModel;
  exports["genericCenter"] = genericCenter;
  exports["decodeCenter"] = decodeCenter;
  exports["encodeCenter"] = encodeCenter;
  exports["genericCenters"] = genericCenters;
  exports["decodeCenters"] = decodeCenters;
  exports["encodeCenters"] = encodeCenters;
})(PS["Models"] = PS["Models"] || {});
...
(function(exports) {
  ...
  var update = function (v) {
      return function (model) {
          if (v instanceof GotCenters && v.value1 instanceof Data_Either.Right) {
              var $15 = {};
              for (var $16 in model) {
                  if ({}.hasOwnProperty.call(model, $16)) {
                      $15[$16] = model[$16];
                  };
              };
              $15.randomness = v.value0;
              $15.centers = v.value1.value0;
              $15.error = "";
              return $15;
          };
          if (v instanceof GotCenters && v.value1 instanceof Data_Either.Left) {
              ...
              $21.randomness = v.value0;
              $21.error = v.value1.value0;
              return $21;
          };
          return model;
      };
  ...
  var spots = function (x) {
      return function (y) {
          return Control_Bind.bind(Control_Bind.bindArray)(Data_Array.range(1)(x))(function (v) {
              return Control_Bind.bind(Control_Bind.bindArray)(Data_Array.range(1)(y))(function (v1) {
  ...
  var serverURL = "http://localhost:8082/http://localhost:8080/";
  ...
  var next = function (v) {
      return function (v1) {
          ...
          if (v instanceof GetCenters) {
              ...
              var domain = Models.Centers(spots(v1.height)(v1.width));
              var body = {
                  size: v1.size,
                  padding: v1.padding,
                  limit: v1.limit,
              ...
              return Oak_Cmd_Http.post(Models.genericCenters)(Data_Foreign_Generic_Class.genericDecodeConstructor(new Data_Symbol.IsSymbol(function () {
                  return "Centers";
              }))(Data_Foreign_Generic_Class.genericDecodeArgsArgument(Data_Foreign_Class.arrayDecode(Models.decodeCenter)))(Data_Foreign_Generic_Class.genericCountArgsArgument))(Models.decodeCenters)(Models.genericTransportModel)(Data_Foreign_Generic_Class.genericEncodeConstructor(new Data_Symbol.IsSymbol(function () {
                  return "TransportModel";
              }))(Data_Foreign_Generic_Class.genericEncodeArgsRec(Data_Foreign_Generic_Class.genericEncodeFieldsProduct(Data_Foreign_Generic_Class.genericEncodeFieldsField(new Data_Symbol.IsSymbol(function () {
                  return "centers";
              }))(Models.encodeCenters))(Data_Foreign_Generic_Class.genericEncodeFieldsProduct(Data_Foreign_Generic_Class.genericEncodeFieldsField(new Data_Symbol.IsSymbol(function () {
                  return "limit";
                  ...
                  return "size";
              }))(Data_Foreign_Class.intEncode))))))))(serverURL)(body)(GotCenters.create(rando));
          };
          return Oak_Cmd.none;
      };
  };
  ...
  var squareView = function (randomness) {
      return function (size) {
          return function (v) {
              ...
              return Oak_Html.rect([ Oak_Html_Attribute.key_(Oak_Html_Present.presentString)(key), Oak_Html_Attribute.x(Oak_Html_Present.presentInt)(v.center_x - positionAdjustment | 0), Oak_Html_Attribute.y(Oak_Html_Present.presentInt)(v.center_y - positionAdjustment | 0), Oak_Html_Attribute.width(Oak_Html_Present.presentString)(dimension), Oak_Html_Attribute.height(Oak_Html_Present.presentString)(dimension), Oak_Html_Attribute.fill(Oak_Html_Present.presentString)(color) ])([  ]);
          };
      };
  };
  var circleView = function (randomness) {
      return function (size) {
          return function (v) {
              ...
              return Oak_Html.circle([ Oak_Html_Attribute.key_(Oak_Html_Present.presentString)(key), Oak_Html_Attribute.cx(Oak_Html_Present.presentInt)(v.center_x - positionAdjustment | 0), Oak_Html_Attribute.cy(Oak_Html_Present.presentInt)(v.center_y - positionAdjustment | 0), Oak_Html_Attribute.r(Oak_Html_Present.presentString)(Data_Show.show(Data_Show.showInt)(size)), Oak_Html_Attribute.fill(Oak_Html_Present.presentString)(color) ])([  ]);
          };
      };
  };
  var shapeView = function (randomness) {
      return function (size) {
          ...
          throw new Error("Failed pattern match at Main line 113, column 1 - line 113, column 46: " + [ randomness.constructor.name, size.constructor.name ]);
      };
  };
  var manyShapes = function (v) {
      return Data_Functor.map(Data_Functor.functorArray)(shapeView(v.randomness)(v.size))(v.centers);
  };
  var view = function (model) {
      var shapes = manyShapes(model);
      return Oak_Html.div([  ])([ Oak_Html.div([  ])([ Oak_Html.text(Oak_Html_Present.presentString)("The laws of physics are only patterns, beginning with quantities.") ]), Oak_Html.div([  ])([ Oak_Html.text(Oak_Html_Present.presentString)("The quantity: " + Data_Show.show(Data_Show.showInt)(Data_Array.length(shapes))) ]), Oak_Html.div([  ])([ Oak_Html.text(Oak_Html_Present.presentString)((function () {
          var $48 = 0 < Data_String.length(model.error);
          if ($48) {
              return "An elegant error has occurred: " + Data_Show.show(Data_Show.showString)(model.error);
          };
          return "";
      })()) ]), Oak_Html.svg([ Oak_Html_Attribute.id_(Oak_Html_Present.presentString)("svg-" + Data_Show.show(Data_Show.showInt)(model.randomness)), Oak_Html_Attribute.key_(Oak_Html_Present.presentString)("svg-" + Data_Show.show(Data_Show.showInt)(model.randomness)), Oak_Html_Attribute.style([ Oak_Css.backgroundColor("blue") ]), Oak_Html_Attribute.height(Oak_Html_Present.presentInt)(model.height), Oak_Html_Attribute.width(Oak_Html_Present.presentInt)(model.width), Oak_Html_Events.onClick(GetRandom.value) ])(shapes) ]);
  };
