  ...
  var squareView = function (randomness) {
      return function (size) {
          return function (v) {
              ...
              return Oak_Html.rect([ Oak_Html_Attribute.key_(Oak_Html_Present.presentString)(key), Oak_Html_Attribute.x(Oak_Html_Present.presentInt)(v.value0 - positionAdjustment | 0), Oak_Html_Attribute.y(Oak_Html_Present.presentInt)(v.value1 - positionAdjustment | 0), Oak_Html_Attribute.width(Oak_Html_Present.presentString)(dimension), Oak_Html_Attribute.height(Oak_Html_Present.presentString)(dimension), Oak_Html_Attribute.fill(Oak_Html_Present.presentString)(color) ])([  ]);
          };
      };
  };
  var circleView = function (randomness) {
      return function (size) {
          return function (v) {
              ...
              return Oak_Html.circle([ Oak_Html_Attribute.key_(Oak_Html_Present.presentString)(key), Oak_Html_Attribute.cx(Oak_Html_Present.presentInt)(v.value0 - positionAdjustment | 0), Oak_Html_Attribute.cy(Oak_Html_Present.presentInt)(v.value1 - positionAdjustment | 0), Oak_Html_Attribute.r(Oak_Html_Present.presentString)(Data_Show.show(Data_Show.showInt)(size)), Oak_Html_Attribute.fill(Oak_Html_Present.presentString)(color) ])([  ]);
          };
      };
  };
